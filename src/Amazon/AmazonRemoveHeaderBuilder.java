...
public class AmazonRemoveHeaderBuilder implements Value<Map<Value<String>, Value<String>>> {
    ...
    public AmazonRemoveHeaderBuilder(Value<URL> endpoint, DateStamp stamp) {
    ...
    public Map<Value<String>, Value<String>> get() {
        ...
        headers.put(new StringText("Authorization"), new AuthorizationHeader(endpoint, new StringText("DELETE"), headers, stamp));
        return headers;
    }
}
